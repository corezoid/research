...
> does not extend to the underlying publication. All statements, designations, and assessments
> reflect the source as published on April 23, 2004.
...
- **See also** [Ukrainian patents](../../patents/ua/) — the awarded technology is patent 50003, «Спосіб підтвердження повноважень користувача на обслуговування» (registered October 15, 2002), the first entry in the index; its Russian sibling (2225679, 2004) made it "protected by patents in both Ukraine and Russia."
- **See also** [Intelligence in the Bank](../../interviews/2014-forbes-intelligence-in-the-bank/english.md) — the 2014 Forbes feature tells the story behind this line of work: linking a card to a "green" phone number so the card could prove the client's identity.
- **See also** [PrivatBank and Visa International Launched the "Convenient Transfers" Service](../2003-privatbank-convenient-transfers/english.md) — the service environment in which the authorisation method was already running when the jury judged it.
