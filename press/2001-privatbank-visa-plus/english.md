...
> Finance.ua and the issuing bank. The translation and the notes around it are offered under
> this repository's text license ([CC BY 4.0](../../LICENSE-CC-BY-4.0)), which does not extend
> to the underlying publication. Factual statements and figures reflect the source as published
> on December 20, 2001.
...
- **See also** [Intelligence in the Bank](../../interviews/2014-forbes-intelligence-in-the-bank/english.md) — the 2014 Forbes feature narrates the instant-issuance technology and Privat24 as parts of PrivatBank's IT story; this release is a contemporaneous record of both, three years before the "world-first mass instant issuance" of 2003.
- **See also** [Ukrainian patents](../../patents/ua/) — the card-personalization and authentication filings of 2002–2004 begin immediately after the period this release documents.
- **See also** [A Phase Model of Enterprise Evolution](../../papers/2026-phase-model-of-enterprise-evolution/) — an early data point of the phase the model describes as the move from fragmented products to a digital core.
